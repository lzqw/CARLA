...
import carla
sys.path.append('/home/lzqw/PycharmProject/Carla-RL/CARLA_Leaderboard_20/PythonAPI/carla')
...
class CarlaDataProvider(object):  # pylint: disable=too-many-public-methods
    ...
    @staticmethod
    def update_ego(ego_vehicle):
        CarlaDataProvider._ego_vehicle=ego_vehicle
    @staticmethod
    def get_ego():
    ...
    @staticmethod
    def get_actors_in_surrounding():
        """
        Get the actor velocity map
        """
        return CarlaDataProvider._carla_actor_pool.copy()
    @staticmethod
